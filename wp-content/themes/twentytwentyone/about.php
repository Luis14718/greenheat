...
<section>
    <div class="row" id="page-main-content">
        <div class="col-xs-12">
        	...
        	<div class="row">
        		<div class="col-xs-12">
        			<div class="grid-menu"><div class="visible-lg-block"><div class="row"><div class="col-3"><div class="center-block grid-menu-item"><a href="https://greenearthheatingandair.com/contact-us/"><span class="img-wrap"><img src="<?php echo get_bloginfo('url');?>/sos-websvc/images/default/contact-us.jpg" alt="Contact Us"></span>Contact Us</a></div></div><div class="col-3"><div class="center-block grid-menu-item"><a href="https://greenearthheatingandair.com/service-area/"><span class="img-wrap"><img src="<?php echo get_bloginfo('url');?>/sos-websvc/images/default/service-areas.jpg" alt="Service Area"></span>Service Area</a></div></div><div class="col-3"><div class="center-block grid-menu-item"><a href="https://greenearthheatingandair.com/history/"><span class="img-wrap"><img src="<?php echo get_bloginfo('url');?>/sos-websvc/images/default/history3.jpg" alt="History"></span>History</a></div></div><div class="col-3"><div class="center-block grid-menu-item"><a href="https://greenearthheatingandair.com/qualifications/"><span class="img-wrap"><img src="<?php echo get_bloginfo('url');?>/sos-websvc/images/default/qualification.jpg" alt="Qualifications"></span>Qualifications</a></div></div></div><div class="row"><div class="col-3"><div class="center-block grid-menu-item"><a href="https://greenearthheatingandair.com/ask-expert/"><span class="img-wrap"><img src="<?php echo get_bloginfo('url');?>/sos-websvc/images/default/ask-the-expert.jpg" alt="Ask the Expert"></span>Ask the Expert</a></div></div><div class="col-3"><div class="center-block grid-menu-item"><a href="https://greenearthheatingandair.com/furnace-heat-pump-air-conditioning-troubleshooting/"><span class="img-wrap"><img src="<?php echo get_bloginfo('url');?>/sos-websvc/images/default/troubleshooting.jpg" alt="DIY Troubleshooting"></span>DIY Troubleshooting</a></div></div></div></div>        		</div>
        	</div>
			<?php get_footer(); ?>